import { View, Text, Dimensions, Image, Platform, TouchableOpacity, FlatList } from 'react-native'
        ...
        <View className="w-full border-t border-primary-200 pt-7 mt-5 px-5">
          ...
          <View className='mt-5 px-5 ' >
                ...
                { property?.facilities.length > 0 && (
                    <View className='flex flex-row flex-wrap items-start justify-start t-2 gap-2' >
                        {
